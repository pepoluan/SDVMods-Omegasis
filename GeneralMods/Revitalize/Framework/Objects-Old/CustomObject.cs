...
namespace Revitalize.Framework.Objects
{
    ...
    public class CustomObject : StardewValley.Object, IEnergyInterface
    {
        ...
        public virtual void initializeBasics()
        {
            ...
            this.displayName = this.getDisplayNameFromStringsFile(this.info.id);
        ...
        {
            this.updateInfo();
            if (drawStackNumber.Equals(StackDrawType.Draw) && this.maximumStackSize() > 1 && ((double)scaleSize > 0.3 && this.Stack != int.MaxValue) && this.Stack > 1)
                Utility.drawTinyDigits(this.Stack, spriteBatch, location + new Vector2((float)(Game1.tileSize - Utility.getWidthOfTinyDigitString(this.Stack, 3f * scaleSize)) + 3f * scaleSize, (float)((double)Game1.tileSize - 18.0 * (double)scaleSize + 2.0)), 3f * scaleSize, 1f, Color.White);
            if (drawStackNumber.Equals(StackDrawType.Draw) && this.Quality > 0)
            {
