    ...
    public class ModCore : Mod
    {
        ...
        private void GameLoop_SaveLoaded(object sender, StardewModdingAPI.Events.SaveLoadedEventArgs e)
        {
            ...
            Game1.player.addItemsByMenuIfNecessary(new List<Item>()
            {
                ...
                ObjectManager.GetItem("TrashCan",1),
                ObjectManager.resources.getResource("Sand",5),
                ...
                ObjectManager.GetItem("CopperWire",10),
                ObjectManager.GetItem("Capacitor",1),
                ObjectManager.GetItem("ChargingStation",1),
                new StardewValley.Object((int)Enums.SDVObject.CopperOre,10),
                ObjectManager.GetTool("ChainsawV1"),
                ObjectManager.GetItem("MiningDrillMachineV1"),
                ObjectManager.GetItem("AlloyFurnace"),
                new StardewValley.Object((int)Enums.SDVObject.IronBar,100),
                ObjectManager.GetItem("WaterPumpV1"),
                ObjectManager.GetItem("SteamBoilerV1"),
                ObjectManager.GetItem("IronPipe",100),
                ObjectManager.GetItem("SteamEngineV1"),
                ObjectManager.GetItem("WindmillV1"),
                ObjectManager.GetItem("WindmillV2")
            });
        }
